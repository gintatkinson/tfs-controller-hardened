...
class DeviceClient:
    ...
    @RETRY_DECORATOR
    def SSETelemetrySubscribe(self, request : SSEMonitoringSubscriptionConfig) -> SSEMonitoringSubscriptionResponse:
        LOGGER.debug('SSETelemetrySubscribe request: {:s}'.format(grpc_message_to_json_string(request)))
