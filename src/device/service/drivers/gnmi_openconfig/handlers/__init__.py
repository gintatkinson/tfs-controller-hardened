...
from .InterfaceSwitchedVlan import InterfaceSwitchedVlanHandler
...
from .NetworkInstanceConnectionPoint import NetworkInstanceConnectionPointHandler
from .NetworkInstanceEndpoint import NetworkInstanceEndpointHandler
from .NetworkInstanceVlan import NetworkInstanceVlanHandler
from .Mpls import MplsHandler
...
ifsvh  = InterfaceSwitchedVlanHandler()
...
nicph  = NetworkInstanceConnectionPointHandler()
nieph  = NetworkInstanceEndpointHandler()
nivlh  = NetworkInstanceVlanHandler()
mplsh  = MplsHandler()
aclh   = AclHandler()
...
RESOURCE_KEY_MAPPER = {
    ...
    '/interface'               : ifaceh.get_resource_key(),
    '/interface/ethernet/switched-vlan' : ifsvh.get_resource_key(),
    '/mpls'                    : mplsh.get_resource_key(),
    '/network_instance/vlan'   : nivlh.get_resource_key(),
    '/mpls/interface'          : mplsh.get_resource_key(),
...
RESOURCE_KEY_TO_HANDLER = {
    ...
    nicph.get_resource_key()  : nicph,
    nieph.get_resource_key()  : nieph,
    nivlh.get_resource_key()  : nivlh,
    mplsh.get_resource_key()  : mplsh,
...
PATH_TO_HANDLER = {
    ...
    ifsvh.get_path()  : ifsvh,
    ifctrh.get_path() : ifctrh,
    nih.get_path()    : nih,
    niifh.get_path()  : niifh,
    niph.get_path()   : niph,
    nisrh.get_path()  : nisrh,
    nicph.get_path()  : nicph,
    nieph.get_path()  : nieph,
    nivlh.get_path()  : nivlh,
    mplsh.get_path()  : mplsh,
    aclh.get_path()   : aclh,
}
