...
class PolicyDeleteServiceTest {
    ...
    static void init() {
        ...
        String policyRuleId = "policyRuleId";
        ...
        List<String> policyRuleKpiIds = new ArrayList<String>();
        policyRuleKpiIds.add("df7efb41-8e6f-4af0-a214-d9863402eca3");

        policyRuleBasic =
                new PolicyRuleBasic(
                        policyRuleId,
                        new PolicyRuleState(PolicyRuleStateEnum.POLICY_INSERTED, "Policy rule inserted"),
                        1,
