...
from common.proto.context_pb2 import (
    ContextId, ServiceStatusEnum, ServiceTypeEnum,
)
...
REQUEST_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'data', 'ietf-l2vpn-service.json')
...
def test_service_ietf_removal(
    ...
    for service in response.services:
        ...
        assert service.service_type == ServiceTypeEnum.SERVICETYPE_L2NM
    ...
    URL = '/restconf/data/ietf-l2vpn-svc:l2vpn-svc/vpn-services/vpn-service={:s}/'.format(service_uuid)
