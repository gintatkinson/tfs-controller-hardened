...
# SW3_1 - SW1_2
LINK_SW3_SW1_UUID           = get_link_uuid(ENDPOINT_ID_SW3_1, ENDPOINT_ID_SW1_2)
LINK_SW3_SW1_ID             = json_link_id(LINK_SW3_SW1_UUID)
LINK_SW3_SW1                = json_link(LINK_SW3_SW1_UUID, [ENDPOINT_ID_SW3_1, ENDPOINT_ID_SW1_2])
...
# SW4_1 - SW2_2
LINK_SW4_SW2_UUID           = get_link_uuid(ENDPOINT_ID_SW4_1, ENDPOINT_ID_SW2_2)
LINK_SW4_SW2_ID             = json_link_id(LINK_SW4_SW2_UUID)
LINK_SW4_SW2                = json_link(LINK_SW4_SW2_UUID, [ENDPOINT_ID_SW4_1, ENDPOINT_ID_SW2_2])

# SW3_2 - SW4_2
LINK_SW3_SW4_UUID           = get_link_uuid(ENDPOINT_ID_SW3_2, ENDPOINT_ID_SW4_2)
LINK_SW3_SW4_ID             = json_link_id(LINK_SW3_SW4_UUID)
LINK_SW3_SW4                = json_link(LINK_SW3_SW4_UUID, [ENDPOINT_ID_SW3_2, ENDPOINT_ID_SW4_2])

# SW4_2 - SW3_2
LINK_SW4_SW3_UUID           = get_link_uuid(ENDPOINT_ID_SW4_2, ENDPOINT_ID_SW3_2)
LINK_SW4_SW3_ID             = json_link_id(LINK_SW4_SW3_UUID)
LINK_SW4_SW3                = json_link(LINK_SW4_SW3_UUID, [ENDPOINT_ID_SW4_2, ENDPOINT_ID_SW3_2])
