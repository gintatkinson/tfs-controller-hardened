...
from common.proto.context_pb2 import (
    Context, ContextId, Device, Empty, Link, Topology,
)
from common.proto.monitoring_pb2 import (
    AlarmDescriptor, AlarmList, KpiDescriptorList,
)
...
from .Fixtures import (
    alarm_descriptor, context_client, device_client, monitoring_client,
