...
# Topology descriptor
DESC_FILE_SERVICE_P4_L2 = os.path.join(TEST_PATH, 'service-p4-l2.json')
assert os.path.exists(DESC_FILE_SERVICE_P4_L2), "Invalid path to the L2 service descriptor"
...
def test_service_creation_l2(
    ...
    descriptor_loader = DescriptorLoader(
        descriptors_file=DESC_FILE_SERVICE_P4_L2,
